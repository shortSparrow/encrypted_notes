...
import 'package:encrypted_notes/data/repositories/modify_note/modify_note.dart';
...
import 'domain/repositories/modify_note_repository.dart';
...
Future<void> init() async {
  ...
  sl.registerSingleton<ModifyNoteRepository>(
      ModifyNoteRepositoryImpl(notesDao: sl()));
