...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String phone, String token, List<int>? bioWedId});
}
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, phone: $phone, token: $token, bioWedId: $bioWedId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, phone, token,
